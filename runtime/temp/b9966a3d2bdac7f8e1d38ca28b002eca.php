<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:82:"/Library/WebServer/Documents/blog/public/../application/admin/view/index/edit.html";i:1532155304;s:75:"/Library/WebServer/Documents/blog/application/admin/view/common/header.html";i:1531755392;s:72:"/Library/WebServer/Documents/blog/application/admin/view/common/nav.html";i:1532165104;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <a href="<?php echo url('index/index'); ?>">系统</a>
                                        ...
                                        <li>
                        <a href="<?php echo url('index/adminList'); ?>">管理员管理</a>
                    </li>
                       ...
                       <input type="hidden" value="<?php echo $data['id']; ?>" name = "id">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input class="form-control" id="userName" placeholder="" name="userName"  type="text"  value = "<?php echo $data['userName']; ?>" >
