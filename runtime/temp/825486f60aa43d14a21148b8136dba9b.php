<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:81:"/Library/WebServer/Documents/blog/public/../application/admin/view/index/add.html";i:1532010446;s:75:"/Library/WebServer/Documents/blog/application/admin/view/common/header.html";i:1531755392;s:72:"/Library/WebServer/Documents/blog/application/admin/view/common/nav.html";i:1532165104;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
                        <div class="form-group">
                            <label for="userName" class="col-sm-2 control-label no-padding-right">账户名</label>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            <label for="group_id" class="col-sm-2 control-label no-padding-right">账户密码</label>
                            <div class="col-sm-6">
