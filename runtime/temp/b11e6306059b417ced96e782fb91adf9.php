<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:87:"/Library/WebServer/Documents/blog/public/../application/admin/view/cate/edit_index.html";i:1532507393;s:75:"/Library/WebServer/Documents/blog/application/admin/view/common/header.html";i:1531755392;s:72:"/Library/WebServer/Documents/blog/application/admin/view/common/nav.html";i:1532532191;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <a href="<?php echo url('index/index'); ?>">系统</a>
                                        ...
                                        <li>
                        <a href="<?php echo url('cate/index'); ?>">栏目列表</a>
                    </li>
                    ...
                    <form class="form-horizontal" role="form" action="<?php echo url('cate/edit'); ?>" method="post">
                       ...
                       <input type="hidden" value="<?php echo $data['id']; ?>" name = "id">
                        ...
                        <div class="form-group">
                            <label for="usertitle" class="col-sm-2 control-label no-padding-right">栏目名称</label>
                            <div class="col-sm-6">
                                
                                <input class="form-control" id="cateName" placeholder="" name="cateName"  type="text"  value = "<?php echo $data['cateName']; ?>" >
