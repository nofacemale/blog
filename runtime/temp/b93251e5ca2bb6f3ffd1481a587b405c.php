		...
		<div class="page-container">
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                                        <li>
                        <a href="<?php echo url('index/index'); ?>">栏目</a>
                    </li>
                                        <li>
                        <a href="<?php echo url('link/index'); ?>">栏目列表</a>
                    </li>
                    ...
                    <form class="form-horizontal" role="form" action="<?php echo url('index/editAdmin'); ?>" method="post">
                       ...
                       <input type="hidden" value="<?php echo $data['id']; ?>" title = "id">
                        ...
                        <div class="form-group">
                            <label for="group_id" class="col-sm-2 control-label no-padding-right">栏目名称</label>
                            <div class="col-sm-6">

                                <input class="form-control" id="cateName" placeholder="" title="cateName"  type="text" value = "<?php echo $data['cateName']; ?>">
